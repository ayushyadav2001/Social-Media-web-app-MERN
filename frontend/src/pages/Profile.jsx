...
const Profile = () => {
  ...
  return (
    ...
    <p className='ms-3 fs-5 text-lowercase '>My Portfolio on <a href='#'>www.johndow.com/{user.user.fullName}</a></p>
    </div>
    ...
    <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
      ...
      <li><a className="dropdown-item" href="#" onClick={() => deletePost(postDetail._id)}><i className="fa-solid fa-trash-can me-1"></i> Delete </a></li>
    </ul>
  </div>
    </div>
